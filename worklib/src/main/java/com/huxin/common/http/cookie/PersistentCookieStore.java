...
public class PersistentCookieStore {
    ...
    public PersistentCookieStore(Context context) {
        ...
        getCookiesFromSp(cookiePrefs,cookies);

    }

    private Map<String, ConcurrentHashMap<String, Cookie>> getCookiesFromSp(SharedPreferences cookiePrefs, Map<String, ConcurrentHashMap<String, Cookie>> cookies) {
